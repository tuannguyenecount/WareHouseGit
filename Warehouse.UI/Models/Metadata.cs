...
namespace Warehouse.Models
{
    ...
    public partial class AspNetUser
    {
        public string AvatarCustom
        {
            get
            {
                if (ConfigurationManager.AppSettings["BaseUrl"] != null)
                {
                    return ConfigurationManager.AppSettings["BaseUrl"].ToString() + "/Photos/ThanhVien/" + this.Avatar;
                }
                else
                    return "/Photos/ThanhVien/" + this.Avatar;
            }
        }
    }
    sealed class AspNetUserMetadata
    {
        ...
        [DisplayFormat(NullDisplayText = "Chưa xác định")]
    ...
    {
        public decimal PriceThuc
        {
            get
            {
                return this.PromotionProduct == null ? this.Price : this.PromotionProduct.PromotionalPrice;
            }
        }
        public string ImageCustom
        {
